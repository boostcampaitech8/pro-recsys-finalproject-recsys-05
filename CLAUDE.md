...
- [x] **배포 완료 (2026-07-07)**: PR #78 머지 → CI 전 구간 통과 (test → arm64 빌드/푸시 → Tailscale SSH deploy.sh → 헬스체크 OK). 80/tcp 개방, 외부 검증 통과: 프론트 200·health 200·docs 403(시큐어존)·공인 22 차단 유지·채팅→Gemini 200. **서비스 URL: http://144.24.66.149/**
